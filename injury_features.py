...
def injury_feature_totals(active: pd.DataFrame) -> dict[str, float]:
    ...
    return {
        ...
        "injured_missing_minutes": float(injured["minutes_played_last_365"].sum()),
        "suspended_missing_minutes": float(suspended["minutes_played_last_365"].sum()),
        "injured_missing_goals": float(injured["goals_last_365"].sum()),
        "suspended_missing_goals": float(suspended["goals_last_365"].sum()),
        "injured_missing_xg": float(injured["xg_contribution_last_365"].sum()),
        "suspended_missing_xg": float(suspended["xg_contribution_last_365"].sum()),
        "injured_missing_xa": float(injured["xa_contribution_last_365"].sum()),
        "suspended_missing_xa": float(suspended["xa_contribution_last_365"].sum()),
        "injured_missing_market_value": float(injured["market_value_eur"].sum()),
        "suspended_missing_market_value": float(suspended["market_value_eur"].sum()),
        "injured_missing_defensive_contribution": float(injured["defensive_contribution_last_365"].sum()),
        "suspended_missing_defensive_contribution": float(suspended["defensive_contribution_last_365"].sum()),
